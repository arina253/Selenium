...
public class Day5bSelf {
    ...
    public static void main(String[] args) {
        ...
        // Test case 3
        login(driver, "problem_user", "secret_sauce");
        WebElement products3 = driver.findElement(By.cssSelector("#item_4_img_link > img"));
        ...
        // Test case 4
        login(driver, "performance_glitch_user", "secret_sauce");
        // Implicitly wait before finding elements to validate.
...
//    }
    ...
    public static int numOfImg(ChromeDriver driver) {
        List<WebElement> images = driver.findElements(By.tagName("img"));  // Use List
        return images.size();
    }
}
