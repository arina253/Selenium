...
public class Day4TestcaseA {
	...
	//Four basic ways to find element by cssSelector:1)tagName 2)class 3) id 4)anyAttribute
	...
	//class
	//Finding  the <h2> element with class "section_header"to find the "CONTACT US" element
